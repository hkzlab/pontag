...
SRC = src/main.c src/libs/ps2_mouse/ps2_mouse.c src/libs/uart/uart.c src/libs/ps22ser/ps22ser.c
...
CINCS = -Isrc/libs/ -Isrc/libs/ps2_mouse/ -Isrc/libs/uart/ -Isrc/libs/ps22ser/
